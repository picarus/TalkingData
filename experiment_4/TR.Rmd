...
xgbSimple <- setHyperPars(xgb, par.vals = list(gamma=0.148, max_depth=8, eta=0.724, min_child_weight=33, colsample_bytree=0.8, colsample_bylevel=0.895, lambda=0.181) )
